...
TetrisDoc.h, TetrisDoc.cpp - the document
    ...
    The Document will have the following strings:
        File extension:      Trs
        File type ID:        Tetris.Document
        Main frame caption:  Tetris
        Doc type name:       Tetris
        Filter name:         Tetris Files (*.Trs)
        File new short name: Tetris
        File type long name: A Tetris Document
